...
export const ServingTracker: React.FC<ServingTrackerProps> = ({ onBack }) => {
  ...
  const analyzeVideo = async () => {
    ...
    // Redefining dimensions was causing duplicate declaration error
    // We already have extractWidth/Height from scaleRatio above (which defaults to MAX_INFERENCE_DIM)
    // So we can just ensure the canvas is right.
